...
// thsi is a long function to draw a morphing shape between a circle AND a star
function drawMorphingShape(x, y, radius1, radius2, t, npoints) {
  ...
  for (let a = 0; a < TWO_PI; a += angle) {
    ...
    if (t < 0.5) {
      let blendedRadius = lerp(radius1, radius2, t * 2); 
      sx = x + cos(a) * blendedRadius;
      sy = y + sin(a) * blendedRadius;
    } else {
      let starRadius = lerp(radius2, radius1, (t - 0.5) * 2); // porpose of this part if to find the star's interpolated radius.
